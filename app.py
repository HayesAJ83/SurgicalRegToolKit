...
def info_bleep():
    ...
    st.write('''* **07790826007** - CEPOD Theatre co-ordinator RIE''')
    ...
    st.write('''* **07814302880** - Vascular Reg Daytime RIE''')
    st.write('''* **2181** bleep - Orthopaedics Junior Reg''')
    st.write('''* **6868** bleep - Orthopaedics Senior Reg''')
    st.write('''* **1682** bleep - Cardiothoracics Reg RIE''')
    ...
    st.write('''* **8272** bleep - Urology Nights FY2''')
